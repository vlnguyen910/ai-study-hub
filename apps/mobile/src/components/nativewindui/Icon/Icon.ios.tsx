...
// NOTE: seems like the need to convert rgba to hex color is a bug in expo-symbols, according to the docs, it should accept a hex color, but it doesn't.
